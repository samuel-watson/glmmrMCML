...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mcml_binomial");
    ...
    reader.add_event(8, 2, "restart", "model_mcml_binomial");
    reader.add_event(25, 17, "end", "model_mcml_binomial");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mcml_binomial
  : public stan::model::model_base_crtp<model_mcml_binomial> {
private:
        int N;
        int P;
        int Q;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(type, 1))) {
                current_statement_begin__ = 19;
                lp_accum__.add(bernoulli_logit_log<propto__>(y, add(Xb, multiply(Z, gamma))));
            }
            current_statement_begin__ = 20;
            if (as_bool(logical_eq(type, 2))) {
                current_statement_begin__ = 20;
                lp_accum__.add(bernoulli_log<propto__>(y, stan::math::exp(add(Xb, multiply(Z, gamma)))));
            }
            current_statement_begin__ = 21;
            if (as_bool(logical_eq(type, 3))) {
                current_statement_begin__ = 21;
                lp_accum__.add(bernoulli_log<propto__>(y, add(Xb, multiply(Z, gamma))));
            }
            current_statement_begin__ = 22;
            if (as_bool(logical_eq(type, 4))) {
                current_statement_begin__ = 22;
                lp_accum__.add(bernoulli_log<propto__>(y, Phi_approx(add(Xb, multiply(Z, gamma)))));
            }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
...
typedef model_mcml_binomial_namespace::model_mcml_binomial stan_model;
#ifndef USING_R
