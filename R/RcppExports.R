...
mcml_full <- function(cov, data, eff_range, Z, X, y, family, link, start, mcnr = FALSE, m = 500L, thin = 5L, maxiter = 30L, warmup = 500L, tol = 1e-3, verbose = TRUE, step_size = 0.015, trace = 0L) {
    .Call(`_glmmrMCML_mcml_full`, cov, data, eff_range, Z, X, y, family, link, start, mcnr, m, thin, maxiter, warmup, tol, verbose, step_size, trace)
}

mcmc_sample <- function(Z, L, X, y, beta, var_par, family, link, warmup, nsamp, thin, step_size = 0.1, trace = 0L) {
    .Call(`_glmmrMCML_mcmc_sample`, Z, L, X, y, beta, var_par, family, link, warmup, nsamp, thin, step_size, trace)
}
...
mcml_doptim <- function(cov, data, eff_range, Z, X, y, u, family, link, start, trace, mcnr = FALSE) {
    invisible(.Call(`_glmmrMCML_mcml_doptim`, cov, data, eff_range, Z, X, y, u, family, link, start, trace, mcnr))
}
