...
mcml_full <- function(cov, data, eff_range, Z, X, y, family, link, start, mcnr = FALSE, m = 500L, thin = 5L, maxiter = 30L, warmup = 500L, tol = 1e-3, verbose = TRUE, trace = 0L) {
    .Call(`_glmmrMCML_mcml_full`, cov, data, eff_range, Z, X, y, family, link, start, mcnr, m, thin, maxiter, warmup, tol, verbose, trace)
}

mcmc_sample <- function(Z, L, X, y, beta, var_par, family, link, warmup, nsamp, thin) {
    .Call(`_glmmrMCML_mcmc_sample`, Z, L, X, y, beta, var_par, family, link, warmup, nsamp, thin)
}
